...
import { useGetReportsQuery, useCreateReportMutation, useDeleteReportMutation } from '@/store/services/apiService';
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', justifyContent: 'flex-end' }}>
                      ...
                      {r.fileUrl ? (
                        <a href={r.fileUrl} target="_blank" rel="noreferrer"
                          ...
                          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '28px', height: '28px', borderRadius: '6px', color: '#8FA3C4', textDecoration: 'none', transition: 'color 0.15s, background 0.15s' }}
                        ...
                        <div style={{ width: '28px', height: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#D1D5DB' }} title="No file">
                          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>
                          </svg>
                        </div>
